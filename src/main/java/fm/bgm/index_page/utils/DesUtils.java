...
/**
 * Created by ZhaoShulin on 2019/9/9 10:59 上午.
 * <br>
 * Desc: 使用DES算法对字符串进行加密解密 (加密解密的操作步骤正好相反, 参考 {@link #encrypt(String)}, {@link #decrypt(String)})
 * <br>
 */
public class DesUtils {
    private static String defaultSecretKey = "KsqyJ9UEwfZnqdiih3gCC2qTtQUfXgsmLGJyxJqMwrHMyKuTa4jmmWnCMEGRuXNJ"; //默认密钥
